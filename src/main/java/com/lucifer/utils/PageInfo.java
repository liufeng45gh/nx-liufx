...
public class PageInfo {
    ...
    public static PageInfo create(Integer page,Integer perPageCount,Integer allRecordCount){
    ...
    public void writeToGateway(Map resultMap){
        Map pageMap = new HashMap<>();
        pageMap.put("total-page",this.getTotalPageCount());
        pageMap.put("total-row",this.getAllRecordCount());
        pageMap.put("page-hasnext",this.isHasNext());
        pageMap.put("page-num",this.getPage());
        pageMap.put("page-row",this.getPerPageCount());
