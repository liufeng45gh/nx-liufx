...
<body style="zoom: 1;">
	<div class="b-container">
        ...
        <div id="wrap">
             <div class="outer with-side with-transition" style="min-height: 600px;">
                    ...
                    <div id="admin_right">
                    			<div class="position"><span>系统</span><span>|</span><span>海富映像</span><span>|</span><span>新增</span></div>
                    			<div class="content form_content" style="width:100%">


                                    <form action="/cms/atlas/add" method="post" id="hfc-form">
                                        <#include "atlas_form_filed.ftl"/>
                                    </form>
                                </div>
                    </div>
             </div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_atlas_add").addClass("selected");
			 var ue = UE.getEditor('editor');
		});
	</script>
    <script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/atlas/atlas_add.js"></script>
