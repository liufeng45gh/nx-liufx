        ...
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="content_box" style="border:none">
                    <div class="position"><span>首页管理</span><span>&gt;</span><span>会员活动</span><span>&gt;</span><span>推荐列表</span></div>
            ...
            <input type="hidden" id="update-url" value="/cms/index/recommend/member-activity-update"/>
            <input type="hidden" id="delete-url" value="/cms/index/recommend/{id}/member-activity-delete"/>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_member_activity").addClass("selected");


		});
	</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/index/member_activity_list.js"></script>
