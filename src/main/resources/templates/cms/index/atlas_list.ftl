        ...
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="content_box" style="border:none">
                    <div class="position"><span>首页管理</span><span>&gt;</span><span>海富映像</span><span>&gt;</span><span>推荐列表</span></div>
                        ...
                        <table class="list_table" style="font-size:13px;">
                            ...
                            <#list indexRecommendList as recommend>
                                <tr >
                                    ...
                                    <td class="t_c">${recommend.target.title?default("")}</td>
                    ...
                    <input type="hidden" id="update-url" value="/cms/index/recommend/atlas-update"/>
                    <input type="hidden" id="delete-url" value="/cms/index/recommend/{id}/atlas-delete"/>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_atlas").addClass("selected");
		});
</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/index/atlas_list.js"></script>
