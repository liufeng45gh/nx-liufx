        ...
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="content_box" style="border:none">
                    <div class="position"><span>首页管理</span><span>&gt;</span><span>三列区块</span><span>&gt;</span><span>列表</span></div>
                    ...
                    <div class="content" style="min-height: 200px;">
                        <table class="list_table" style="font-size:13px;">
                            ...
                            <tbody>
                            <#list threeBlockList as carousel>
                                <tr>
                    ...
                    <div class="content form_content" >
                        ...
                        <div class="position"><span>添加</span></div>
                        <form action="/cms/index/three-block/add" method="post"  id="hfc-form">
                            <table class="table_new" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="update-url" value="/cms/index/three-block/{id}/update"/>
                                        <input type="hidden" id="delete-url" value="/cms/index/three-block/delete"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_three_block").addClass("selected");
		});
	</script>
